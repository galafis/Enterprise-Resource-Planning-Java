package com.galafis.enterprise-resource-planning-java;
...
/**
 * Enterprise-Resource-Planning-Java - Professional Java Implementation
...
public class ERPSystem {
    ...
    public CompletableFuture<Void> initialize() {
        return CompletableFuture.runAsync(() -> {
            System.out.println("Initializing Enterprise-Resource-Planning-Java System...");
    ...
    public static void main(String[] args) {
        System.out.println("Starting Enterprise-Resource-Planning-Java...");
